...
public interface BBsMainDao {
	...
	public void insert(BBsMainVO vo); // 데이터 추가는 한개씩 추가하는 것이 원칙
	public List<BBsMainVO> selectAll(); // 조건없이 전체
	public BBsMainVO findById(long id); // ID를 기준으로 한개의 데이터 조회
